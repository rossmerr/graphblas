...
func (s *MutexMatrix) Update(r, c int, f func(bool) bool) {
	s.Lock()
	defer s.Unlock()
...
func (s *MutexMatrix) At(r, c int) bool {
	s.RLock()
	defer s.RUnlock()
...
func (s *MutexMatrix) Set(r, c int, value bool) {
	s.Lock()
	defer s.Unlock()
...
func (s *MutexMatrix) RowsAtToArray(r int) []bool {
	s.RLock()
	defer s.RUnlock()
