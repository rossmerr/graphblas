...
func TestCSCScalar(t *testing.T) {
	m := GraphBLAS.NewCSCMatrix(2, 2)
	m.Set(0, 0, 4)
	m.Set(0, 1, 0)
	m.Set(1, 0, 1)
	m.Set(1, 1, -9)
...
func TestCSCMultiple(t *testing.T) {
...
func TestCSCSubtract(t *testing.T) {
	m := GraphBLAS.NewCSCMatrix(2, 2)
	m.Set(0, 0, 3)
	m.Set(0, 1, 8)
	m.Set(1, 0, 4)
...
func TestCSCNegative(t *testing.T) {
	m := GraphBLAS.NewCSCMatrix(2, 2)
	m.Set(0, 0, 2)
	m.Set(0, 1, -4)
	m.Set(1, 0, 7)
